        ...
        <form method="POST">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="inputEmail4" required name="title" value="<?php echo $singlepost['title']; ?>" placeholder="PHP etc....">
                </div>

            </div>
            <div class="form-group" style="width: 50%">
                <label for="inputAddress">Description</label>
                <textarea type="text" class="form-control"  name="description"  required placeholder="Description"><?php  echo $singlepost['description']; ?>
                </textarea>
            </div>
            </div>
